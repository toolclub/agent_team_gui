...
.atg-composer{max-width:330px;transition:border-color .15s,background .15s}.atg-composer.is-on{border-color:color-mix(in srgb,var(--dsw-alias-state-success-primary) 55%,var(--dsw-alias-border-l2));background:color-mix(in srgb,var(--dsw-alias-state-success-primary) 5%,var(--dsw-alias-bg-layer-1))}.atg-mode-label{flex:none;padding:1px 5px;border-radius:5px;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-tertiary);font:650 9px/16px var(--dsw-font-family);text-transform:uppercase}.atg-composer.is-on .atg-mode-label{color:var(--dsw-alias-state-success-primary)}.atg-project-pin{flex:none;width:19px;height:19px;padding:0;border:0;background:transparent;color:var(--dsw-alias-label-dimmed);font-size:12px;cursor:pointer}.atg-project-pin.is-on{color:#e6a400;text-shadow:0 0 8px color-mix(in srgb,#e6a400 45%,transparent)}
