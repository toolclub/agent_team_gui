...
const zh = {
  ...
  statusPlanning: '规划中', statusQueued: '排队中', statusRunning: '运行中', statusCompleted: '已完成', statusPartial: '部分完成', statusFailed: '失败', statusCancelled: '已取消', statusInterrupted: '已中断', statusTimedOut: '已超时', statusSkipped: '已跳过', statusAwaitingApproval: '待审批', statusRejected: '已拒绝',
  ...
  stopRun: '停止运行', retryRun: '重试整次运行', retryMember: '仅重试此成员', exportRun: '导出运行', approvePlan: '批准计划', rejectPlan: '拒绝', runGone: '这条运行记录已被清理或超出保留范围；列表已刷新。', clearHistory: '清理已结束历史', clearConfirm: '确定清理当前对话中已结束的运行历史吗？',
...
const en: Record<keyof typeof zh, string> = {
  ...
  statusPlanning: 'Planning', statusQueued: 'Queued', statusRunning: 'Running', statusCompleted: 'Completed', statusPartial: 'Partial', statusFailed: 'Failed', statusCancelled: 'Cancelled', statusInterrupted: 'Interrupted', statusTimedOut: 'Timed out', statusSkipped: 'Skipped', statusAwaitingApproval: 'Awaiting approval', statusRejected: 'Rejected',
  ...
  stopRun: 'Stop run', retryRun: 'Retry full run', retryMember: 'Retry this member only', exportRun: 'Export run', approvePlan: 'Approve plan', rejectPlan: 'Reject', runGone: 'This run was cleared or aged out of retention; the list has been refreshed.', clearHistory: 'Clear settled history', clearConfirm: 'Clear settled run history for this conversation?',
